    ...
    <Container maxW="5xl" px={{ base: 6, md: 3 }} py={10}>
      <Stack direction={{ base: "column-reverse", md: "row" }}>
        <Stack direction="column" spacing={6}>
          ...
          >
            Curiosity sparks, knowledge ignites with Vigyasa.
          </Heading>
          <Text
          ...
          >
            Vigyasa is your gateway to early learning success, providing
            JEE-NEET foundation classes to nurture young minds. Our platform is
            designed to foster curiosity and ignite the thirst for knowledge,
            empowering students in their educational journey.
          </Text>
          <HStack spacing={3}>
            <Button
              colorScheme="teal"
          ...
          <HStack spacing={5}>
            {["Interactive Learning", "Personalized Approach"].map(
              (text, index) => (
